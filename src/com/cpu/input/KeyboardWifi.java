...
public class KeyboardWifi extends InputMethodService {
	...
	public void onCreate() {
		super.onCreate();
                ...
                Toast.makeText(this, "use: telnet 10.42.0.101 9090", Toast.LENGTH_LONG).show();
	...
	public View onCreateInputView() {
		View view = getLayoutInflater().inflate(R.layout.keyboardwifi, null);
