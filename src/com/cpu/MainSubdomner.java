...
public class MainSubdomner extends Activity 
{
    ...
    public void setMainLayout() {
        layout = "main";
        setContentView(R.layout.main_browser_subdomner);
        try {
        ...
        findViewById(R.id.starttask).setOnClickListener(starttask);
    ...
    public void setHistoryLayout() {
        ...
        if(hx.length == 0) {
            ...
            layout = "history";
            setContentView(R.layout.history_subdomner);
            findViewById(R.id.historyBack).setOnClickListener(historyBack);
            ...
            historyList.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    try {
                        ...
                        setContentView(R.layout.status_subdomner);
                        riwayat = (ListView) findViewById(R.id.riwayat);
                        ...
                        okres = (RadioButton) findViewById(R.id.okresponse);
                        otres = (RadioButton) findViewById(R.id.otherresponse);
                        findViewById(R.id.okresponse).setOnClickListener(okresponse);
                        findViewById(R.id.otherresponse).setOnClickListener(otherresponse);
                        findViewById(R.id.statusBack).setOnClickListener(statusBack);
                    } catch(Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch(item.getItemId()) {
            case R.id.clear: dom.setText("");console.setText("");banner();
                break;
            case R.id.about: 
